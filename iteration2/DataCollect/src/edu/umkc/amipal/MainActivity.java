...
public class MainActivity extends Activity implements BluetoothAdapter.LeScanCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        accValue = (TextView) findViewById(R.id.acc_reading);
        gyroValue = (TextView) findViewById(R.id.gyro_reading);
        /*
    ...
    private void clearDisplayValues() {
       /* mTemperature.setText("---");
        mHumidity.setText("---");
        mPressure.setText("---");*/
        accValue.setText("Not connected");
        gyroValue.setText("Not connected");
    }
...
*/
    ...
    private static final int MSG_ACCELEROMETER = 401;
    private static final int MSG_GYROSCOPE = 501;
    private static final int MSG_GYROSCOPE_CAL = 502;
            ...
            switch (msg.what) {
               /* case MSG_HUMIDITY:
                ...
                case MSG_GYROSCOPE:
                    characteristic = (BluetoothGattCharacteristic) msg.obj;
                    if (characteristic.getValue() == null) {
                        Log.w(TAG, "Error Obtaining Gyro value");
                        return;
                    }
    ...
    private void updateGyroValues(BluetoothGattCharacteristic characteristic){
        ...
        gyroValue.setText(gyroData);
        
        Log.i("gyro","gyro    "+gyroData);
    }
    private void updateAccelerometerCals(BluetoothGattCharacteristic characteristic) {
        //if (mPressureCals == null) return;
        //double pressure = SensorTagData.extractBarometer(characteristic, mPressureCals);
        String accelerationData = SensorTagData.extractAccelerometerReading(characteristic, 0);
        //Log.i(TAG,accelerationData);
        accValue.setText(accelerationData);
        java.util.Date date= new java.util.Date();
        Log.i("accelerometer",new Timestamp(date.getTime())+","+accelerationData);
       // mTemperature.setText(String.format("%.1f\u00B0C", temp));
        //mPressure.setText(String.format("%.2f", pressure));
